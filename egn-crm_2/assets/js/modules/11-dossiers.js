...
let CHARGES_POSTE='', CHARGES_FOURN='';
...
function setChargesPoste(v){CHARGES_POSTE=v;if(v!=='ma')CHARGES_FOURN='';renderComptaResume();}
...
function renderDetailCharges(T,eur){
  ...
  let h=`<div style="display:flex;align-items:center;gap:.8rem;flex-wrap:wrap;margin-bottom:.9rem">
    <button class="btn btn-ghost btn-sm" onclick="RESUME_VUE='';RESUME_Q='';CHARGES_POSTE='';CHARGES_FOURN='';renderComptaResume()">← Retour au résumé</button>
